        ...
        <div className="row">
            ...
            <div className="col-md-6 mb-4">
              <div className="service-card position-relative overflow-hidden rounded-4">
                <img src="https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?auto=format&fit=crop&w=800&q=80" alt="Chemical Analysis" className="w-100 h-100 object-cover" style={{
                height: "400px"
              }} />
