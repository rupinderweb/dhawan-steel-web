        ...
        <div className="w-full flex items-center justify-between">
          ...
          {isMobile ? (
            <Collapsible open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <CollapsibleContent className="absolute top-full left-0 right-0 bg-zinc-950 mt-0 p-4 shadow-lg w-full z-[100]">
                <ul className="navbar-nav text-center flex flex-col gap-3">
